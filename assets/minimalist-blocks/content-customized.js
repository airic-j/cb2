    ...
    'snippets': [
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<img src="assets/minimalist-blocks/oleg-laptev-545268-unsplash-VD7ll2.jpg">' +
					'</div>' +
				'</div>'
		},
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/jon-lalin-731093-unsplash-(1)-tdmMt1.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
					'</div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/adam-birkett-209727-unsplash-(2)-H2BMm1.jpg">' +
					'</div>' +
				'</div>'
		},
		{
		...
		'html':
				'<div class="row clearfix">' +
                    '<div class="column half">' +
                        '<img src="assets/minimalist-blocks/jon-lalin-731093-unsplash-(1)-tdmMt1.jpg" style="margin: 0;float: left;">' +
                    '</div>' +
                    '<div class="column half">' +
                        '<img src="assets/minimalist-blocks/adam-birkett-209727-unsplash-(2)-H2BMm1.jpg" style="margin: 0;float: left;">' +
                    '</div>' +
                '</div>'
},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
                    '<div class="column third">' +
                        '<img src="assets/minimalist-blocks/chuttersnap-413002-unsplash-83HqE1.jpg" style="margin: 0;float: left;">' +
                    '</div>' +
                    '<div class="column third">' +
                        '<img src="assets/minimalist-blocks/caroline-bertolini-270870-unsplash-1j5FB2.jpg" style="margin: 0;float: left;">' +
                    '</div>' +
                    '<div class="column third">' +
                        '<img src="assets/minimalist-blocks/theo-roland-740436-unsplash-WqnWJ3.jpg" style="margin: 0;float: left;">' +
                    '</div>' +
                '</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
                    '<div class="column full">' +
                        '<img src="assets/minimalist-blocks/oleg-laptev-545268-unsplash-VD7ll2.jpg" style="margin: 0;float: left;">' +
                    '</div>' +
                '</div>'
		},
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/pawel-czerwinski-1080345-unsplash-Zxz1W1.jpg">' +
						'\n<h3 class="size-21">IMAGE CAPTION</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text</p>' +
					'</div>' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/agata-create-1137058-unsplash-(1)-UvBs02.jpg">' +
						'\n<h3 class="size-21">IMAGE CAPTION</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text</p>' +
					'</div>' +
				'</div>'
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/monika-grabkowska-742426-unsplash-AtCtH1.jpg">' +
						'\n<h3 class="size-18">CAPTION</h3>' +
						'\n<p class="size-14" style="color: rgb(136, 136, 136);">Lorem Ipsum is dummy text.</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/mira-bozhko-456995-YiVKC1.jpg">' +
						'\n<h3 class="size-18">CAPTION</h3>' +
						'\n<p class="size-14" style="color: rgb(136, 136, 136);">Lorem Ipsum is dummy text.</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/lauren-mancke-63448-unsplash-AtCtH2.jpg">' +
						'\n<h3 class="size-18">CAPTION</h3>' +
						'\n<p class="size-14" style="color: rgb(136, 136, 136);">Lorem Ipsum is dummy text.</p>' +
					'</div>' +
				'</div>'
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<img src="assets/minimalist-blocks/susanne-schwarz-1142929-unsplash-IZGK11.jpg">' +
						'\n<h3 class="size-21">IMAGE CAPTION</h3>' +
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/art-materials-close-up-color-pencils-1484263-jT5E21.jpg" style="border-radius: 500px;">' +
						'\n<p class="size-14">Lorem Ipsum is dummy text</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/oleg-laptev-546607-unsplash-SKGb82.jpg" style="border-radius: 500px;">' +
						'\n<p class="size-14">Lorem Ipsum is dummy text</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/michal-grosicki-XG2yA3.jpg" style="border-radius: 500px;">' +
						'\n<p class="size-14">Lorem Ipsum is dummy text</p>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/remi-muller-359340-unsplash-JOL3q1.jpg">' +
						'\n<p><i>Lorem Ipsum is dummy text</i></p>' +
					'</div>' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/dlanor-s-591314-unsplash-maNC32.jpg">' +
						'\n<p><i>Lorem Ipsum is dummy text</i></p>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/agata-create-1132088-unsplash-(1)-adQTO1.jpg">' +
						'\n<p>IMAGE CAPTION</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/lucrezia-carnelos-1127196-unsplash-Y7ahO2.jpg">' +
						'\n<p>IMAGE CAPTION</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/bright-bulb-close-up-1166643-oof1G3.jpg">' +
						'\n<p>IMAGE CAPTION</p>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<img src="assets/minimalist-blocks/omar-lopez-32084-8ciiC1.jpg">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/-ORebV1.jpg">' +
					'</div>' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/ian-dooley-298771-unsplash-Hu2RU3.jpg">' +
					'</div>' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/daniel-klopper-1142809-unsplash-pToHm2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<img src="assets/minimalist-blocks/anthony-tran-1076077-vcoLP1.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column two-third">' +
						'<img src="assets/minimalist-blocks/rawpixel-1200191-unsplash-Ms1O81.jpg">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img src="assets/minimalist-blocks/iman-soleimany-zadeh-1205567-unsplash-AUqMZ2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/maksym-zakharyak-688728-unsplash-p9w092.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-40"></div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/rodion-kutsaev-24833-unsplash-HEuVp1.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column two-third">' +
						'<img src="assets/minimalist-blocks/monica-galentino-102655-unsplash-gfbdC1.jpg">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img src="assets/minimalist-blocks/rawpixel-1197453-unsplash-a7ozj2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-XstZ21.jpg">' +
						'\n<img src="assets/minimalist-blocks/-budQW2.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/sarah-dorweiler-211779-unsplash-dN96G1.jpg">' +
						'\n<img src="assets/minimalist-blocks/kris-atomic-39874-unsplash-vpMhe2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/rawpixel-1197458-unsplash-J52N31.jpg">' +
					'</div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-5F3zm1.jpg">' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div style="padding-right:30px">' +
							_tabs(1) + '<img src="assets/minimalist-blocks/-4r9Fa1.jpg">' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-80"></div>' +
				...
				'<div class="row clearfix">' +
					...
					'<div class="column half">' +
						'<div style="padding-left:30px">' +
							_tabs(1) + '<img src="assets/minimalist-blocks/-lbizY1.jpg">' +
						'\n</div>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-ocaLR1.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-40"></div>' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-mHAa32.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column two-third">' +
						'<img src="assets/minimalist-blocks/-OJKzv1.jpg">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img src="assets/minimalist-blocks/-I81sR1.jpg">' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/bangkit-ristant-395541-e0mhz1.jpg" style="border-radius: 500px;">' +
						'\n<h3 class="size-21" style="letter-spacing: 2px;">VINCENT NELSON</h3>' +
						'\n<p style="color: #b7b7b7">WEB DESIGNER</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/redd-angelo-427759-33bDf2.jpg" style="border-radius: 500px;">' +
						'\n<h3 class="size-21" style="letter-spacing: 2px;">NATHAN WILLIAMS</h3>' +
						'\n<p style="color: #b7b7b7">WEB DEVELOPER</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/mads-schmidt-rasmussen-186319-8AVbA1.jpg" style="border-radius: 500px;">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/samuel-zeller-413072-Tx4ai1.jpg">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/michael-236683-Tx4ai2.jpg">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/michael-221247-Hspxi3.jpg">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/working-2618559_1920-kr4Af1.jpg">' +
						'\n<h5 style="letter-spacing: 3px;">Sarah Doe</h5>' +
						'\n<p style="color: rgb(136, 136, 136);">Founder</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/rawpixel-632454-unsplash-ecHZN1.jpg">' +
						'\n<h5 style="letter-spacing: 3px;">David Anderson</h5>' +
						'\n<p style="color: rgb(136, 136, 136);">Programmer</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/girl-2618562_1920-KAzoZ2.jpg">' +
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/adult-1868750_1920-EzivE1.jpg" style="border-radius: 500px;">' +
						'\n<h3 class="size-24">David Smith</h3>' +
						'\n<p style="color: rgb(136, 136, 136);;">CEO & Founder</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/noah-buscher-502067-(1)-rT7Vn1.jpg" style="border-radius: 500px;">' +
						'\n<h3 class="size-24">Milla Clarke</h3>' +
						'\n<p style="color: rgb(136, 136, 136);;">Project Manager</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/berwin-coroza-495276-tXRrf2.jpg" style="border-radius: 500px;">' +
						'\n<h3 class="size-24">John Rugg</h3>' +
						'\n<p style="color: rgb(136, 136, 136);;">Developer</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/mark-skeet-537093-6gF113.jpg" style="border-radius: 500px;">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/girl-690119-c7s4t1.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<h2>Your Name</h2>' +
						'\n<p>Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/photo-1437915160026-6c59da36ede2-AakHA2.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<h2>Your Name</h2>' +
						'\n<p>Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<div class="is-card max-390 is-light-text" style="background: #1c93ad;">' +
							_tabs(1) + '<img src="assets/minimalist-blocks/bernard-osei-608155-unsplash-BsEPC1.jpg" class="margin-0">' +
					...
					'<div class="column third">' +
						'<div class="is-card max-390 is-light-text" style="background: #e0527e;">' +
							_tabs(1) + '<img src="assets/minimalist-blocks/-HAWqm1.jpg" class="margin-0">' +
							_tabs(1) + '<div class="margin-25 center">' +
					...
					'<div class="column third">' +
						'<div class="is-card max-390 is-light-text" style="background: #e17055">' +
							_tabs(1) + '<img src="assets/minimalist-blocks/girl-from-behind-1741699-(1)-PqduN2.jpg" class="margin-0">' +
							_tabs(1) + '<div class="margin-25 center">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/rawpixel-632454-unsplash-oLoHS1.jpg" style="border-radius: 500px;">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/-tfqUv1.jpg" style="border-radius: 500px;">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/rawpixel-1054600-unsplash-PylVl2.jpg" style="border-radius: 500px;">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/sarah-noltner-687653-unsplash-6Agfw1.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/luke-porter-520986-unsplash-kjuDr1.jpg" style="border-radius: 500px;">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/nicole-honeywill-546846-unsplash-(1)-84PNj2.jpg" style="border-radius: 500px;">' +
					'</div>' +
					'<div class="column half">' +
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/alex-iby-480498-unsplash-JOL3q3.jpg" style="border-radius: 500px;">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/nordwood-themes-166423-unsplash-(1)-4WJ2H1.jpg">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/-9Htn91.jpg">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/parker-johnson-1100877-unsplash-(1)-rufBy1.jpg">' +
					'</div>' +
					'<div class="column half">' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/beautiful-close-up-color-1078058-Qywhs1.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/daniel-apodaca-584113-unsplash-(1)-U9Iby1.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/alex-shaw-1116446-unsplash-JWfd61.jpg" style="border-radius: 500px;">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/-JMXQP1.jpg" style="border-radius: 500px;">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/simon-migaj-775713-unsplash-l8oSx1.jpg" style="border-radius: 500px;">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-6Q6W91.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-80"></div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-ayzzH2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-fxBmr1.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-6SDpQ1.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/-z01lr1.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-SRJrq2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-otLsK1.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-TUrpQ1.jpg">' +
					'</div>' +
				'</div>'
		},

        {
            ...
            'html':
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/-DbQGW1.jpg" style="border-radius: 500px">' +
					'</div>' +
					'<div class="column two-third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/-gs7XT1.jpg">' +
					'</div>' +
					'<div class="column two-third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-DjWQ71.jpg" style="border-radius: 500px;">' +
					'</div>' +
					'<div class="column half">' +
						'<div style="padding-left:40px">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-c2y4f1.jpg" style="border-radius: 500px;">' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/photo-1459411552884-841db9b3cc2a-YO89Y1.jpg">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/photo-1471256737566-c7ddd846bee0-small-NBNfZ2.jpg">' +
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<div class="is-card is-dark-text shadow-1">' +
							_tabs(1) + '<div class="margin-25">' +
								_tabs(2) + '<img src="assets/minimalist-blocks/x98sw2520-sh1J31.jpg" style="border-radius: 500px">' +
					...
					'<div class="column third center">' +
						'<div class="is-card is-dark-text shadow-1">' +
							_tabs(1) + '<div class="margin-25">' +
								_tabs(2) + '<img src="assets/minimalist-blocks/georgie-cobbs-467923-unsplash-G9q9p2.jpg" style="border-radius: 500px">' +
					...
					'<div class="column third center">' +
						'<div class="is-card is-dark-text shadow-1">' +
							_tabs(1) + '<div class="margin-25">' +
								_tabs(2) + '<img src="assets/minimalist-blocks/martin-widenka-555176-unsplash-sh1J33.jpg" style="border-radius: 500px">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/-7eFyL1.jpg">' +
						'\n<h3 class="size-21">PRODUCT NAME</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p><a href="#">BUY NOW</a></p>' +
					'</div>' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/-09yZA2.jpg">' +
						'\n<h3 class="size-21">PRODUCT NAME</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p><a href="#">BUY NOW</a></p>' +
					'</div>' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/-Tmg8p2.jpg">' +
						'\n<h3 class="size-21">PRODUCT NAME</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p><a href="#">BUY NOW</a></p>' +
					'</div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/h-e-n-g-s-t-r-e-a-m-573432-unsplash-xt89A1.jpg" alt="">' +
					...
					'</div>' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/sarah-dorweiler-357724-unsplash-4cfGV2.jpg" alt="">' +
						'\n<h3 class="size-24" style="font-weight: 400;">PRODUCT NAME, <span style="color: rgb(136, 136, 136);">$79</span></h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
						'\n<p><a href="#" title="">BUY NOW</a></p>' +
					'</div>' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/michael-frattaroli-234662-unsplash-QaduA1.jpg" alt="">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-5v3uL1.jpg">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-C3XHH1.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<div style="padding-left: 40px">' +
							_tabs(1) + '<h1 class="size-42">Product Name</h1>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/-7Vn0R1.jpg">' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/nordwood-themes-473050-jFvLM1.jpg">' +
						'\n<p style="color: rgb(136, 136, 136); font-weight: normal;">' +
							_tabs(1) + 'PRODUCT NAME' +
							_tabs(1) + '<br>' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/toa-heftiba-448302-(1)-pXDhf1.jpg">' +
						'\n<p style="color: rgb(136, 136, 136); font-weight: normal;">' +
							_tabs(1) + 'PRODUCT NAME' +
							_tabs(1) + '<br>' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/-p8OMT2.jpg">' +
						'\n<p style="color: rgb(136, 136, 136); font-weight: normal;">' +
							_tabs(1) + 'PRODUCT NAME' +
							_tabs(1) + '<br>' +
							_tabs(1) + '<a href="#" title="">$99</a>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/imac-Bz83W1.png">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="list">' +
							_tabs(1) + '<i class="icon ion-checkmark"></i>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/kara-michelle-544960-zjkQn1.jpg">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img src="assets/minimalist-blocks/aidan-hancock-440776-unsplash-8u7fo1.jpg">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/workplace-1245776_1280-oxBIU1.jpg">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/desk-office-hero-workspace-(1)-V8F292.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-BwYjC1.jpg"></div>' +
					'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<div class="spacer height-40"></div>' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-FrSUb2.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<div style="padding-right:30px">' +
							_tabs(1) + '<img src="assets/minimalist-blocks/-sGkY41.jpg">' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-UPno91.jpg">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-lkx4s2.jpg">' +
					'</div>' +
					'<div class="column half">' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-sJf643.jpg">' +
					'</div>' +
				'</div>'
		},
...

        {
            ...
            'html':
		    	...
		    	'<div class="row clearfix">' +
		    		'<div class="column half center">' +
		    			'<img src="assets/minimalist-blocks/-F0dm51.jpg">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<img src="assets/minimalist-blocks/-x5GRp1.jpg">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-S0R1k1.jpg">' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry. — Nelson Sand</p>' +
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-QqxYJ2.jpg">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column third center">' +
		    			'<img src="assets/minimalist-blocks/-F6TCZ1.jpg">' +
		    		'</div>' +
		    		'<div class="column two-third">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column third center">' +
		    			'<img src="assets/minimalist-blocks/-Q1XSO1.jpg" style="border-radius: 500px">' +
		    		'</div>' +
		    		'<div class="column two-third">' +
		    			'<div style="margin-top:10px"><i class="icon ion-quote size-24" style="color: #888888"></i></div>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
...

		{
		    ...
		    'html':
		    	...
		    	'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-akB4h1.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="quote">' +
							_tabs(1) + '<i class="icon ion-quote"></i>' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-R79NY2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
		    	...
		    	'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-ybeSl1.jpg" style="border-radius: 500px;">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="quote">' +
							_tabs(1) + '<i class="icon ion-quote"></i>' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-KUCDN4.jpg" style="border-radius: 500px;">' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/watch-1663246_1920-8wuCM1.jpg">' +
						'\n<div class="spacer height-20"></div>' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/-frUlS1.jpg">' +
						'\n<div class="spacer height-20"></div>' +
						'\n<i class="icon ion-quote size-24"></i>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p class="size-14">by Your Name</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/-RXypm2.jpg">' +
						'\n<div class="spacer height-20"></div>' +
						'\n<i class="icon ion-quote size-24"></i>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p class="size-14">by Your Name</p>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/noah-buscher-548633-ExLNF1.jpg" style="border-radius: 500px;">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/icons8-team-355990-Voloz1.jpg" style="border-radius: 500px;">' +
						'\n<p style="color: #bdc3c7"><i class="icon ion-android-hangout size-32"></i></p>' +
						'\n<p class="size-16">Lorem Ipsum is simply dummy text of the printing industry. — Clara Wang</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/pexels-photo-girl-zZWwv1.jpg" style="border-radius: 500px;">' +
						'\n<p style="color: #bdc3c7"><i class="icon ion-android-hangout size-32"></i></p>' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column half">' +
		    			'<img src="assets/minimalist-blocks/-6PDKL1.jpg">' +
		    		'</div>' +
		    		'<div class="column half">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="assets/minimalist-blocks/-OWu2H1.jpg">' +
					'</div>' +
				'</div>'
		},
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column center full">' +
		    			'<img src="assets/minimalist-blocks/-TK4An1.jpg" style="border-radius: 500px">' +
		    		'</div>' +
		    	'</div>' +
		    	'<div class="row clearfix">' +
		    		'<div class="column center full">' +
...

		{
			...
			'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/creative.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/light-studio.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/infinitech.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/design-firm.png">' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/sitepro.png">' +
						'</div>' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/steady.png">' +
						'</div>' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/creative.png">' +
						'</div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/onesight.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/mmedia.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/digitalmag.png">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column fourth">' +
						'<img src="assets/minimalist-blocks/upclick.png">' +
					'</div>' +
					'<div class="column fourth">' +
						'<img src="assets/minimalist-blocks/onesight.png">' +
					'</div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/worldwide.png">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/bbuzz.png">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/prosource.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/light-studio.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/nett.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/worldwide.png">' +
					'</div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<img src="assets/minimalist-blocks/lost-2747289-ThbrT1.png">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<img src="assets/minimalist-blocks/-5TpV91.jpg">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full center">' +
